              ...
              <div className="header-upper-links d-flex align-items-center justify-content-end gap-3 header-user-actions">
                <div className="single-icon ">
                  ...
                  >
                    ...
                    <p className="d-none d-xl-block mb-0 header-upper-text">
                      Compare <br /> Products
                    </p>
                  </Link>
                </div>
                ...
                <div className="single-icon px-2">
                  ...
                  >
                    ...
                    <div className="d-none d-xl-block d-flex flex-column gap-10 justify-content-center">
                      <span className="d-block badge bg-white text-dark fs-xsm fw-normal rounded-pill mb-1">
                        0
                      </span>
        ...
        <ul className="dropdown-list">
          ...
          <li className="dropdown-item">
            <a href="#">Makeup Kit</a>
              ...
              <li className="menu-category">
                <NavLink to="/all-products" className="menu-title">
                  Our Products
                </NavLink>
              </li>
              {/* <li className="menu-category">
          ...
          <li className="dropdown-item">
            <a href="#">Bajaj</a>
              ...
              <li className="menu-category">
                <a href="/AboutUs" className="menu-title">
                  About Us
                </a>
              </li>
        ...
        <nav className="mobile-navigation-menu  has-scrollbar" data-mobile-menu>
          ...
          <div className="menu-bottom">
            ...
            <ul className="menu-social-container">
              <li>
                <a href="https://www.facebook.com/GoblinKen" className="social-link">
              ...
              <li>
                <a href="https://www.instagram.com/goblinkenofficial/" className="social-link">
                  <ion-icon name="logo-instagram"></ion-icon>
                </a>
              </li>

              <li>
                <a href="https://www.linkedin.com/company/goblinken/" className="social-link">
